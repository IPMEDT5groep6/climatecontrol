...
Servo servoRechts;  //
Servo servoLinks; // Servo object aangemaakt om de servo aan te sturen
...
{
  lcd.begin(16, 2);
  servoLinks.attach(4); // Servo voor het linker raam, op Pin 4 (PWM pin)
  servoRechts.attach(7); // Servo voor rechter raam , op pin 7 (PWM Pin)
